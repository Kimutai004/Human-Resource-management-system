...
// Generated by dart2js (fast startup emitter, strong, trust primitives, omit checks, lax runtime type), the Dart to JavaScript compiler version: 2.10.1.
    ...
    _asyncStarHelper: function(object, bodyFunctionOrErrorCode, controller) {
      ...
      if (object instanceof P._IterationMarker) {
        ...
        if (t1 === 0) {
          ...
          stream = object.value;
          controller.get$controller().addStream$2$cancelOnError(stream, false).then$1(new P._asyncStarHelper_closure0(controller, bodyFunctionOrErrorCode));
          return;
        }
      }
    ...
    Future_wait: function(futures, $T) {
      ...
      try {
        for (t1 = J.get$iterator$ax(futures), t2 = type$.Null; t1.moveNext$0();) {
          ...
          future.then$1$2$onError(new P.Future_wait_closure(_box_0, pos, _future, cleanUp, eagerError, _error_get, _stackTrace_get, $T), handleError, t2);
          ++_box_0.remaining;
        }
        t1 = _box_0.remaining;
        if (t1 === 0) {
